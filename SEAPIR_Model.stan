functions {
  ...
  real[] seapir(real t, real[] y, real[] theta, 
      ...
      # beta = beta + to_vector(x_r[i:i])' * to_vector(theta[2:]);
...
parameters {
  ...
  real<lower=0> phi_inv; # new!
  
}

transformed parameters{

  real phi = 1. / phi_inv; # new!
...
model {
  ...
  phi_inv ~ exponential(5); #new!
  
  // sampling distribution
  infections ~  neg_binomial_2(lambda, phi); #new
}
